...
import 'package:flutter_drawing_board/widgets/progress_widget.dart';
import 'package:flutter_drawing_board/widgets/rating_star_widget.dart';
...
void initState() {
 super.initState();
 model = widget.model; // Assurez-vous que model est initialisé ici
}
